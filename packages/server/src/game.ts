  ...
  private interactProp(
    ...
    if (prop.kind === "phonebooth") {
      ...
      if (roll < 0.32) {
        ...
        this.log(
          session,
          `${label}: tip line. (−$${cost}, rep +1) "Dogs west, wreckers further west, rats fringe, lizards far lot, slicks east, chrome knuckles mid-fringe, toll strip, freeze crate docks, vipers south neon, Iron Temple after hours. Don't call this number again."`,
        );
      } else if (roll < 0.58) {
        // Collect-call scam
